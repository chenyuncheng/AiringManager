...
//                0x00, 0x01 });
        String str1 = "010600000001";
        String str2 = "010600000000";//"010620010001";
        byte[] bstr = new BigInteger(str1, 16).toByteArray();
...
//        System.out.println(String.format("%04x", crc2));
        System.out.println(String.format("%04x", CRC16Util.calcCrc16(bstr)).toUpperCase());
        System.out.println(String.format("%04x", CRC16Util.calcCrc16(bstr2)).toUpperCase());
