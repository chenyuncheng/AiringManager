...
<html>
<head>
    <title>声波驱离器管理平台-用户登录</title>
    <meta name="viewport" content="width=device-width">
    <%@ include file="/commons/basejs.jsp" %>
    <link rel="stylesheet" type="text/css" href="${staticPath }/static/style/css/login.css?v=${version}" />
    <script type="text/javascript" src="${staticPath }/static/js/login.js?v=${version启动}" charset="utf-8"></script>
</head>
<body onkeydown="enterlogin();">
<div class="top_div">
    <div class="center_text">声波驱离器管理平台</div>
</div>
